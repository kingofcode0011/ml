    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < COOLDOWN_TIME:
                response = "You Are On Cooldown ❌. Pʟᴇᴀsᴇ Wᴀɪᴛ 10sᴇᴄ Tᴏ Usᴇ Tʜᴇ /mustafa Cᴏᴍᴍᴀɴᴅ ᴀɢᴀɪɴ."
                bot.reply_to(message, response)
                return
        ...
        response = ("🚫 Uɴᴀᴛʜᴏʀɪᴢᴇᴅ Aᴄᴄᴇss! 🚫\n\nOops! Iᴛ Sᴇᴇᴍs Lɪᴋᴇ Yᴏᴜ Dᴏɴ'ᴛ Hᴀᴠᴇ Pᴇʀᴍɪssɪᴏɴ Tᴏ Usᴇ Tʜᴇ /mustafa Cᴏᴍᴍᴀɴᴅ. DM TO BUY ACCESS:- @SIDIKI_MUSTAFA_47")
